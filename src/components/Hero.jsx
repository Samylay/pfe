    ...
    <div className="text-black w-full h-screen bg-zinc-200 flex flex-col justify-between">
      <div className="flex flex-col md:flex-row justify-center items-center  py-20 m-auto w-full">
        <div className="flex flex-col items-center w-full px-2 py-8">
          <h1 className="font-bold text-6xl md:text-7xl lg:text-8xl my-4">
            BIENVENUE
          </h1>
          ...
          <div className="flex flex-row justify-center items-center w-full">
            <button
              onClick={GotoLogin}
              className="px-8 text-red-600 bg-zinc-200 border font-semibold hover:bg-red-800 hover:text-white border-red-600
